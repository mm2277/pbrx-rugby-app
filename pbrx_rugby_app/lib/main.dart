...
//this is auto-generated code from using the extract widget function
class BigCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //somehow makes it so that the style extracted doesn't drown against the primary colour of the theme
...
class FavoritesPageExample extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var appState = context.watch<MyAppState>();
